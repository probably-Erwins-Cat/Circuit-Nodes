...
# Getting Started with Circuit Nodes
...
- Mounting holes for base assembly
- Connector pads for magnetic connections
...
### Minimum Setup
1. **PCBs** - At least 3-5 basic pieces to form a simple circuit
2. **3D-Printed Bases** - One per PCB
3. **Magnetic Connectors** - About 2 per piece (depending on connections needed)
...
1. Download Gerber files from the repository
2. Order PCBs from a fabrication service
3. Source magnetic connectors and screws
4. Print the bases on a 3D printer
5. Assemble following the detailed instructions
